...
class Contacto extends Component {
    ...
    handleFormSubmit = (event) => {
        ...
        axios.post("http://localhost:5000/api/contacto",{ nombre, telefono, email, mensaje })
        .then( () => { 
                        ...
                        <br/>
                                ...
                                <form class="info-form" onSubmit={this.handleFormSubmit}>
                                            ...
                                            <label>Telefono:</label>
                                                        <input class="" type="number" name="telefono" placeholder="NUMERO" value={this.state.telefono} onChange={ e => this.handleChange(e)}></input> 
                                                        
                                                    
                                                        <label>Mensaje:</label>
                                                        <input class="" type="string" name="mensaje" placeholder="" value={this.state.mensaje} onChange={ e => this.handleChange(e)}></input>  
