      ...
      <div>
        <div>
          ...
          <form onSubmit={(e) => this.handleSubmit(e)}>
            ...
            <input type="file" onChange={(e) => this.handleFileUpload1(e)} />
            <input type="file" onChange={(e) => this.handleFileUpload2(e)} />
            <input type="file" onChange={(e) => this.handleFileUpload3(e)} />
