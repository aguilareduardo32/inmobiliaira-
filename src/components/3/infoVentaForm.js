    ...
    return (
      <div>
        <div className="servicios1" style={sectionStyle}>
          ...
          <h2 className="y">
            {" "}
            La venta o alquiler de su propiedad implica mucho más que un aviso
            en su ventana o una publicación en Internet.
            <br />
            <br />
            Nuestro servicio le proporciona total asesoramiento en cada una de
            las etapas de su operación inmobiliaria.
          </h2>
        </div>
        <div className="texxto">
          ...
          <p>
            ...
            orden y que no haya trámites que completar para evitar contratiempos
            en la venta o alquiler.
            <br />
            <br />
            ...
            <br />
            <br />
            3.Realizamos un Análisis de Mercado Comparativo basado en la oferta
            actual y la demanda histórica de inmuebles en su zona, para
            determinar con toda precisión el precio óptimo de venta o alquiler
            de su propiedad.
            <br />
            <br />
            ...
            difusión de la información de su propiedad en la Red de CENTURY 21;
            el contar con una cartera de prospectos calificados; nuestra
            política de compartir de forma equitativa con el universo de Agentes
            Inmobiliarios de México; le garantiza la venta o alquiler de su
            propiedad en el mejor precio y menor tiempo.
            <br />
            ...
            ofrecer soluciones inmobiliarias de calidad, garantizando clientes
            de por vida.
            <br />
            <br />
            5.Ofrecemos la asesoría necesaria que le permitirá hacer las mejoras
            a su propiedad para lograr un impacto positivo en los clientes que
            la visiten.
            <br />
            <br />
            6.Nuestros Agentes cuentan con el profesionalismo para brindar a los
            clientes la información profesional y una demostración adecuada de
            su propiedad.
            <br />
            <br />
            7.Evaluamos a los prospectos para evitarle molestias innecesarias,
            además por su seguridad siempre acompañamos a todo prospecto que
            visite su propiedad.
            <br />
            <br />
            ...
            negociados todos los detalles de la operación, lo asesoraremos con
            todos los pasos y documentos a fin de perfeccionar su operación de
